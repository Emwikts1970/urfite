...
If you try to compute OLS with a set of regressors that suffer from perfect multicollinearity the system will warn you and ignore the regressor(s) which is(are) assumed to be a linear combination of the others.
```{r}
# Example 1
library(AER)                                                    # contains the dataset 
data(CASchools) 
