...
E.g. using the definition of the $p$-value for a two sided test, we can confirm the $p$-value for the intercept coeffiecient to be approximatley zero:
