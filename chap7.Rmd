...
If we want to compute confidence intervalls at another level of $\alpha$, 0.1 say, we have the change the argument `level` of the `confint` function accordingly.
