...
If we consider two coefficients, their confidence set is an ellipse. Again, there is a very convenient way to plot the "confidence ellipse" for coefficients of model objects, namely the function `ellipse` which is also coming with the `car` package.
