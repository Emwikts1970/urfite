...
so this actually leads to the same interval. Obviously, this interval does not contain the value zero what, as we have already seen in section 5.1, leads to rejection of the null hypothesis $\beta_{1,0} = 0$.
