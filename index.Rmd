...
The next code chunk reproduces table 4.1 from the text book. In order to have a nice display format we gather all data after the computation in a data frame. 

<div class="fold o">

```{r Table 4.1, results='hold'}
avg_tsratio   <- mean(CASchools$tsratio) 
avg_tsratio   <- mean(CASchools$score)
