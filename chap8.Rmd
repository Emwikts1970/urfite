...
With a p-value less than $0.05$ the null hypothesis that the regression function is linear is rejected against the alternative that it is
quadratic or cubic. 
...
$$\widehat{TestScore} = 607.3 + 3.85Income - 0.0423Income^2 \text{ ?}$$
...
$$\Delta \hat{Y} = (\hat{\beta_0 } + \hat{\beta_1} \times 11 + \hat{\beta_2} \times 11^2) - (\hat{\beta_0 } + \hat{\beta_1} \times 10 + \hat{\beta_2} \times 10^2) $$
...
$$Y_i = \beta_0 + \beta_1\ln(X_i) + u_i \text{, } i=1,...,n. $$
