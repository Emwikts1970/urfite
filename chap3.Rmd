...
Take the code and try out different values for `size` (the sample size). Notice how the interval on the x-axis becomes smaller as you increase it. The deviation from $\mu$ becomes smaller the higher the sample size is. The probability that the deviation from the true value is smaller than any given small $\tau$ converges to 1 as $n$ grows. This behavior is called consistency of $\hat{\mu}$.
...
<div class="folded">
```{r, echo=T, eval=T, message = F, warning = F, results='hold'}
